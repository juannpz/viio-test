...
const ProductDetail = () => {
    ...
    return (
        <div className="p-4 bg-white rounded-lg shadow-md">
            ...
            <div className="p-4">
                <h1 className="text-2xl font-semibold text-blue-700 mb-4">{product.title}</h1>
                <h2 className="text-lg font-semibold text-blue-700">{product.brand}</h2>
                ...
                {product.discount && (
                    <p className="mt-2 text-sm text-red-500">Descuento: {product.discount}%</p>
                )}
            </div>
        </div>
    )
