...
const LoginForm = () => {
    ...
    return (
        <form className="flex flex-col space-y-4 bg-gray-200 p-4 rounded border border-gray-300 shadow-lg" onSubmit={handleFormSubmit}>
            ...
            <button className="bg-blue-500 text-white py-2 rounded hover:bg-blue-600 transition-colors duration-300" type="submit">Log in</button>
            ...
            <div className="flex items-center justify-center space-x-2">
                ...
                <button type="button" className="text-blue-500 hover:underline" onClick={() => navigate("/register")}>Sign up</button>
            </div>
        </form>
    )
}
